...
describe("onboardingSchema", () => {
  ...
  it("should accept all valid diet values", () => {
    for (const diet of ["herbivore", "omnivore", "carnivore", "opportunistic"]) {
  ...
  it("should accept all valid transport values", () => {
    for (const transport of ["none", "public", "private", "mixed", "aviation_heavy"]) {
...
describe("specimenSchema", () => {
  it("should validate a valid specimen", () => {
    const result = specimenSchema.safeParse({
      ...
      description: "Once the dominant form of personal transportation involving physical vehicle control.",
...
describe("fieldNoteSchema", () => {
  it("should validate a valid field note", () => {
    const result = fieldNoteSchema.safeParse({
      ...
      content: "Observed the specimen engaging in remarkable behavior patterns.",
